...
Revision ID: 6ab79280cc2b
Revises:
Create Date: 2024-05-27 20:37:41.924029
...
def downgrade():
    ...
    op.drop_table('users')
    # Comment out or remove the drop table for contacts if you wish to keep it
